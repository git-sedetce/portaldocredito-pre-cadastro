...
import { JurisdicaoAgentesRoutingModule } from './jurisdicao-agentes-routing.module';
...
@NgModule({
  declarations: [JurisdicaoAgentesComponent],
  imports: [
    CommonModule,
    FormsModule,
    FlexLayoutModule,
    ...
    MatMenuModule,
    MatCardModule,
    JurisdicaoAgentesRoutingModule
  ]
})
export class JurisdicaoAgentesModule { }
